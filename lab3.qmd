...
The radial SVM acheived approximately sensitivity of 0.347, specificity of 0.706, and misclassification of 0.47 on the test set. This was better than degree 3 polynomial, but not better than the linear SVM.

### Team and individual SVM plot

```{r}
# bar plot mc rate for each model
model_names <- c("Linear SVM", "Degree 3 SVM", "Radial SVM (Team)")
mcrates <- c(0.45, 0.49, 0.47)
